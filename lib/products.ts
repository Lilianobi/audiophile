...
export const products: Product[] = [
  // HEADPHONES
  {
    ...
    others: ['xx99-mark-one-headphones', 'xx59-headphones', 'zx9-speaker'],
  },
  {
    ...
    others: ['xx99-mark-two-headphones', 'xx59-headphones', 'zx9-speaker'],
  },
  {
    id: 'xx59-headphones',
    ...
    others: ['xx99-mark-two-headphones', 'xx99-mark-one-headphones', 'zx9-speaker'],
  },
  ...
  // SPEAKERS
  {
    ...
    features: 'Connect via Bluetooth or nearly any wired source. This speaker features optical, digital coaxial, USB Type-B, stereo RCA, and stereo XLR inputs, allowing you to have up to five wired source devices connected for easy switching. Improved bluetooth technology offers near lossless audio quality at up to 328ft (100m).\n\nDiscover clear, more natural sounding highs than the competition with ZX9 signature planar diaphragm tweeter. Equally important is its powerful room-shaking bass courtesy of a 6.5 inch aluminum alloy bass unit. You will be able to enjoy equal sound quality whether in a large room or small den. Furthermore, you will experience new sensations from old songs since it can respond to even the subtle waveforms.',
    includes: [
    ...
    others: ['zx7-speaker', 'xx99-mark-one-headphones', 'xx59-headphones'],
  },
  {
    id: 'zx7-speaker',
    slug: 'zx7-speaker',
    ...
    new: false,
    price: 3500,
    description: 'Stream high fidelity sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.',
    ...
    others: ['zx9-speaker', 'xx99-mark-one-headphones', 'xx59-headphones'],
  },
...
export function getRelatedProducts(productId: string): Product[] {
  ...
  if (!product || !product.others) return [];
